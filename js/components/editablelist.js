...
(function () {
    ...
    class EditableList extends HTMLElement {
        ...
        constructor() {
            ...
            const editableListContainer = document.createElement('div'); // creating a container for the editable-list component
            ...
            editableListContainer.innerHTML = `
                ...
                <div style="border:solid green 6px; position:relative; display:inline-block; border-radius:5px;">
                    <h3>${title}</h3>
                    <ul class="item-list xitem">
                      ${listItems.map(item => `
                        <li>${item}
