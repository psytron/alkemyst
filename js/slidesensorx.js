...
SlideSensor = function( scroll_target ){
    ...
    function getIntersection( ev ){
        ...
        var intersects = raycaster.intersectObjects( scroll_target.children ,false );  // c , recursive
        
        for( var i =0; i<intersects.length; i++){
            console.log(' click intersect : ', i )
        };
    ...
    plane.on('mousedown', this.onDownEvent );
