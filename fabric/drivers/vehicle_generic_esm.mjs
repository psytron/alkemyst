...
async function report( dat ){ 

    var meth = dat.method; 

    // Delete specified keys from dat before processing
    const keysToDelete = ['fn', 'id', 'label', 'level', 'uuid'];
...
export { init , login , logout , reset , register , status , sendOperation , query , report }
